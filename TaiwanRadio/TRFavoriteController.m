...
- (void)__setupDataSource
{
    ...
    NSArray *sortByName    = [toArray sortedArrayUsingDescriptors:@[sort]];
    NSArray *favorites     = [TRFavoriteHandel favorites];
    NSPredicate *filter    = [NSPredicate predicateWithFormat:@"channel_id IN %@", favorites];
    
    _dataSource = [[sortByName filteredArrayUsingPredicate:filter]mutableCopy];
